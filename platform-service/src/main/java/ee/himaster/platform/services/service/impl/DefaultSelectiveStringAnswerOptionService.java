...
@Service
@Slf4j
public class DefaultSelectiveStringAnswerOptionService extends AbstractModelService<SelectiveStringAnswerOptionModel> implements AnswerOptionService<SelectiveStringAnswerOptionModel> {
